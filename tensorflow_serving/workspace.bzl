...
def tf_serving_workspace():
    ...
    native.http_archive(
        name = "dragnn_model",
        urls = [
            "https://github.com/ClarabridgeInc/models/archive/v0.5.tar.gz",
        ],
        sha256 = "d4b531f025e21dd4f3d0273f0aba6f69d13a1a14046317c37c57b3653017daae",
        strip_prefix = "models-0.5/research/syntaxnet",
    )
